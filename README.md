...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fastds-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13390&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fastds-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fastds` can be installed with:

```
conda install fastds
```

It is possible to list all of the versions of `fastds` available on your platform with:
